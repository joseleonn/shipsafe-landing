      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <ScrollReveal variant="blur">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-center text-lg text-white/75">
            Si en tu empresa alguna de estas situaciones se repite, SHIPSAFE es para vos.
          </p>
        </ScrollReveal>
        ...
        <div className="mt-12 grid gap-4 sm:grid-cols-2">
          {PAINS.map((pain, i) => (
            ...
            >
              ...
              >
                <SpotlightCard className="h-full rounded-xl border border-white/10 bg-white/[0.05] p-6 backdrop-blur-sm transition-shadow duration-300 group-hover:shadow-lg group-hover:shadow-accent/10">
