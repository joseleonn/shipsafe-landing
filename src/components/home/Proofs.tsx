    ...
    <section className="proofs" id="caso">
      <div className="wrap">
        <div className="sec-head">
          <div className="eyebrow num"><span>09</span>Casos</div>
          <h2>
      ...
      <Reveal className="erp" delay={0.06}>
        ...
        <p>
          El sistema corporativo sigue siendo el sistema corporativo. <b>SHIPSAFE resuelve el día a
          día que ese sistema nunca iba a resolver:</b> la inspección al lado de la caldera, el
          permiso que se firma desde otra sucursal, el KPI que hoy alguien arma a mano.
        </p>
        <ul className="ticks">
          <li><Icon name="check" /><span><b>Sucursales.</b> Sabés qué pasa en la otra sin viajar, y qué está por vencer allá.</span></li>
          <li><Icon name="check" /><span><b>Permisos de trabajo.</b> Se revisan, aprueban y firman a distancia.</span></li>
